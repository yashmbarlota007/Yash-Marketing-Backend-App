...
function openModal(orderId) {
    ...
    // FORMATTING FIX: Clean the number and ensure '91' is attached
    let cleanPhone = "";
    if (order.phone) {
    ...
    let waUrl = cleanPhone ? `https://wa.me/${cleanPhone}?text=${encodeURIComponent(finalMsg)}` : `https://wa.me/?text=${encodeURIComponent(finalMsg)}`;
